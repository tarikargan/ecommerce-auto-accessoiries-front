...
@Component({
  selector: 'app-production-paiement',
  templateUrl: './production-paiement.component.html',
  styleUrls: ['./production-paiement.component.scss']
})
export class ProductionPaiementComponent {
