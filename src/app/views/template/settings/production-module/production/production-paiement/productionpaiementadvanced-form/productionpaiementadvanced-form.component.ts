...
@Component({
  selector: 'app-productionpaiementadvanced-form',
  templateUrl: './productionpaiementadvanced-form.component.html',
  styleUrls: ['./productionpaiementadvanced-form.component.scss']
})
export class ProductionpaiementadvancedFormComponent {
